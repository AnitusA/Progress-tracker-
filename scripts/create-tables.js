...
if (!SUPABASE_URL || !SERVICE_ROLE_KEY) {
  ...
  console.error('Get-Content .env | ForEach-Object { if($_ -match "^([^=]+)=(.*)$") { [System.Environment]::SetEnvironmentVariable($matches[1], $matches[2], "Process") } }; node scripts/create-tables.js')
  process.exit(1)
}
